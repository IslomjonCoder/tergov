          ...
          children: [
            Column(
              ...
              children: [
                Row(
                  children: [
                    Expanded(child: SmallEarningsWidget(title: S.of(context).victim, price: r'$40000', discount: '%23', since: 'since last month', onTap: () {  })),
                    Expanded(child: SmallEarningsWidget(title: S.of(context).accused, price: r'$57434', discount: '%20', since: 'since last year', onTap: () {  })),
                  ].separatedBy(const Gap(20)),
                ),
                Row(
                  children: [
                    Expanded(child: SmallEarningsWidget(title: S.of(context).suspect, price: r'$67700', discount: '%36', since: 'since last weak', onTap: () {  })),
                    Expanded(child: SmallEarningsWidget(title: S.of(context).legalRepresentative, price: r'$87600', discount: '%27', since: 'since last year', onTap: () {  })),
                  ].separatedBy(const Gap(20)),
                ),
              ].separatedBy(const Gap(20)),
            ),
